...
struct server_routes {
    ...
    // MiniCPM-o / omni streaming API
    server_http_context::handler_t post_stream_prefill;
    server_http_context::handler_t post_stream_decode;
    server_http_context::handler_t post_stream_omni_init;
    server_http_context::handler_t post_stream_break;
    server_http_context::handler_t post_stream_reset;
    server_http_context::handler_t post_stream_update_session_config;
private:
