...
enum llm_kv {
    ...
    LLM_KV_QUANTIZATION_METHOD,
    LLM_KV_QUANTIZATION_BITS,
    LLM_KV_QUANTIZATION_GROUP_SIZE,
    LLM_KV_QUANTIZATION_ZERO_POINT,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ATTN_QKV,
    LLM_TENSOR_ATTN_OUT,
    LLM_TENSOR_ATTN_Q_AWQ_QWEIGHT,
    LLM_TENSOR_ATTN_Q_AWQ_QZEROS,
    LLM_TENSOR_ATTN_Q_AWQ_SCALES,
    LLM_TENSOR_ATTN_K_AWQ_QWEIGHT,
    LLM_TENSOR_ATTN_K_AWQ_QZEROS,
    LLM_TENSOR_ATTN_K_AWQ_SCALES,
    LLM_TENSOR_ATTN_V_AWQ_QWEIGHT,
    LLM_TENSOR_ATTN_V_AWQ_QZEROS,
    LLM_TENSOR_ATTN_V_AWQ_SCALES,
    LLM_TENSOR_ATTN_OUT_AWQ_QWEIGHT,
    LLM_TENSOR_ATTN_OUT_AWQ_QZEROS,
    LLM_TENSOR_ATTN_OUT_AWQ_SCALES,
    ...
    LLM_TENSOR_FFN_DOWN,
    LLM_TENSOR_FFN_UP,
    LLM_TENSOR_FFN_GATE_AWQ_QWEIGHT,
    LLM_TENSOR_FFN_GATE_AWQ_QZEROS,
    LLM_TENSOR_FFN_GATE_AWQ_SCALES,
    LLM_TENSOR_FFN_DOWN_AWQ_QWEIGHT,
    LLM_TENSOR_FFN_DOWN_AWQ_QZEROS,
    LLM_TENSOR_FFN_DOWN_AWQ_SCALES,
    LLM_TENSOR_FFN_UP_AWQ_QWEIGHT,
    LLM_TENSOR_FFN_UP_AWQ_QZEROS,
    LLM_TENSOR_FFN_UP_AWQ_SCALES,
    LLM_TENSOR_FFN_ACT,
