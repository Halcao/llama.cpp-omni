...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_QUANTIZATION_METHOD,     "%s.quantization.method"     },
    { LLM_KV_QUANTIZATION_BITS,       "%s.quantization.bits"       },
    { LLM_KV_QUANTIZATION_GROUP_SIZE, "%s.quantization.group_size" },
    { LLM_KV_QUANTIZATION_ZERO_POINT, "%s.quantization.zero_point" },
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_QWEN3,
        {
            ...
            { LLM_TENSOR_ATTN_NORM,       "blk.%d.attn_norm" },
            { LLM_TENSOR_ATTN_Q,          "blk.%d.attn_q" },
            { LLM_TENSOR_ATTN_Q_AWQ_QWEIGHT, "llm.model.layers.%d.self_attn.q_proj.qweight" },
            { LLM_TENSOR_ATTN_Q_AWQ_QZEROS,  "llm.model.layers.%d.self_attn.q_proj.qzeros" },
            { LLM_TENSOR_ATTN_Q_AWQ_SCALES,  "llm.model.layers.%d.self_attn.q_proj.scales" },
            { LLM_TENSOR_ATTN_Q_NORM,     "blk.%d.attn_q_norm" },
            { LLM_TENSOR_ATTN_K,          "blk.%d.attn_k" },
            { LLM_TENSOR_ATTN_K_AWQ_QWEIGHT, "llm.model.layers.%d.self_attn.k_proj.qweight" },
            { LLM_TENSOR_ATTN_K_AWQ_QZEROS,  "llm.model.layers.%d.self_attn.k_proj.qzeros" },
            { LLM_TENSOR_ATTN_K_AWQ_SCALES,  "llm.model.layers.%d.self_attn.k_proj.scales" },
            { LLM_TENSOR_ATTN_K_NORM,     "blk.%d.attn_k_norm" },
            { LLM_TENSOR_ATTN_V,          "blk.%d.attn_v" },
            { LLM_TENSOR_ATTN_V_AWQ_QWEIGHT, "llm.model.layers.%d.self_attn.v_proj.qweight" },
            { LLM_TENSOR_ATTN_V_AWQ_QZEROS,  "llm.model.layers.%d.self_attn.v_proj.qzeros" },
            { LLM_TENSOR_ATTN_V_AWQ_SCALES,  "llm.model.layers.%d.self_attn.v_proj.scales" },
            { LLM_TENSOR_ATTN_OUT,        "blk.%d.attn_output" },
            { LLM_TENSOR_ATTN_OUT_AWQ_QWEIGHT, "llm.model.layers.%d.self_attn.o_proj.qweight" },
            { LLM_TENSOR_ATTN_OUT_AWQ_QZEROS,  "llm.model.layers.%d.self_attn.o_proj.qzeros" },
            { LLM_TENSOR_ATTN_OUT_AWQ_SCALES,  "llm.model.layers.%d.self_attn.o_proj.scales" },
            { LLM_TENSOR_FFN_NORM,        "blk.%d.ffn_norm" },
            { LLM_TENSOR_FFN_GATE,        "blk.%d.ffn_gate" },
            { LLM_TENSOR_FFN_GATE_AWQ_QWEIGHT, "llm.model.layers.%d.mlp.gate_proj.qweight" },
            { LLM_TENSOR_FFN_GATE_AWQ_QZEROS,  "llm.model.layers.%d.mlp.gate_proj.qzeros" },
            { LLM_TENSOR_FFN_GATE_AWQ_SCALES,  "llm.model.layers.%d.mlp.gate_proj.scales" },
            { LLM_TENSOR_FFN_DOWN,        "blk.%d.ffn_down" },
            { LLM_TENSOR_FFN_DOWN_AWQ_QWEIGHT, "llm.model.layers.%d.mlp.down_proj.qweight" },
            { LLM_TENSOR_FFN_DOWN_AWQ_QZEROS,  "llm.model.layers.%d.mlp.down_proj.qzeros" },
            { LLM_TENSOR_FFN_DOWN_AWQ_SCALES,  "llm.model.layers.%d.mlp.down_proj.scales" },
            { LLM_TENSOR_FFN_UP,          "blk.%d.ffn_up" },
            { LLM_TENSOR_FFN_UP_AWQ_QWEIGHT, "llm.model.layers.%d.mlp.up_proj.qweight" },
            { LLM_TENSOR_FFN_UP_AWQ_QZEROS,  "llm.model.layers.%d.mlp.up_proj.qzeros" },
            { LLM_TENSOR_FFN_UP_AWQ_SCALES,  "llm.model.layers.%d.mlp.up_proj.scales" },
        },
    },
    {
        LLM_ARCH_QWEN3MOE,
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_Q_AWQ_QWEIGHT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_AWQ_QZEROS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_AWQ_SCALES,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_AWQ_QWEIGHT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_AWQ_QZEROS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_AWQ_SCALES,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_AWQ_QWEIGHT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_AWQ_QZEROS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_AWQ_SCALES,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_AWQ_QWEIGHT,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_AWQ_QZEROS,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_AWQ_SCALES,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP,                     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_AWQ_QWEIGHT,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_AWQ_QZEROS,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE_AWQ_SCALES,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_AWQ_QWEIGHT,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_AWQ_QZEROS,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_AWQ_SCALES,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_AWQ_QWEIGHT,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_AWQ_QZEROS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP_AWQ_SCALES,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
