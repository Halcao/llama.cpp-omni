...
struct common_params {
    ...
    // tools/omni (MiniCPM-o): auxiliary model paths (HTTP API / CLI may set these)
    std::string vpm_model;                   // vision encoder GGUF
    std::string apm_model;                   // audio encoder GGUF
    std::string tts_model;                   // TTS weights GGUF
    std::string vision_coreml_model_path;    // optional CoreML bundle for vision on Apple ANE
